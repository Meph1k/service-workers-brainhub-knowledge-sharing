...
var cacheNames = ['brainhub-v1'];
var cacheAssets = ['/', '/index.html', '/kitten.4431d989.jpeg', '/service-workers-project.e31bb0bc.js', '/styles.8986bff4.css'];
self.addEventListener('install', function (event) {
  console.log('SW installed!');
  event.waitUntil(caches.open(cacheNames[0]).then(function (cache) {
    console.log('cache: ', cache);
    cache.addAll(cacheAssets);
  }).then(function () {
    return self.skipWaiting();
  }) // prevents the waiting, meaning the service worker activates as soon as it's finished installing.
  );
});
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","service-worker.js"], null)
